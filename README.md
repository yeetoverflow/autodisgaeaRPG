...
* Go to Settings in Nox instance
  ...
  * Device
      * (Required) Device profile => Choose predefined profile => Samsung Galaxy S20 Ultra
* Install DisgaeaRPG
* Note: If you are using a 4k monitor and nox emulator, the top and side bars are larger. You will need to open nox instance while you are at a lower resolution. After that you can change your resolution back.
